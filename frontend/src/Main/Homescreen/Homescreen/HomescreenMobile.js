...
import MobileAppIcon from '../../App Icons/MobileAppIcon';
...
function HomescreenMobile({ showSplash, isSplashScreenGone, toggleFooterVisibility, closeFooter }) {
  ...
  return (
    <div ref={contentRef} className="pt-16 mx-auto flex flex-col items-center justify-start min-h-screen px-4 opacity-0">
      ...
      <button
        className="fixed bottom-4 right-4 w-12 h-12 text-white rounded-full flex items-center justify-center bg-white bg-opacity-50 backdrop-blur-3xl z-2"
