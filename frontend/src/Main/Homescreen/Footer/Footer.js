      ...
      <div className="text-center space-y-4">
        ...
        {unsplashData ? (
          <p className="text-sm footer-text">
            Photo by 
            <GlowingLink 
              href={`${unsplashData.user.links.html}?utm_source=your_app_name&utm_medium=referral`}>{unsplashData.user.name}
            </GlowingLink> on 
            <GlowingLink 
              href="https://unsplash.com/?utm_source=your_app_name&utm_medium=referral">Unsplash
            </GlowingLink>
          </p>
        ) : (
